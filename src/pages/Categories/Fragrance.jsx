...
import rawFragranceHtml from '@legacy/pages/categories/fragrance.html?raw';
...
import pageStyles from '@/assets/css/pages/categories/fragrance.css?inline';

const Fragrance = () => {
  const pageRef = useRef(null);
  const content = useMemo(() => transformLegacyHtml(rawFragranceHtml), []);

  useEffect(() => {
    document.title = 'Fragrance - Mosaic Beauty';
  }, []);

  useScopedCss(pageStyles, 'fragrance-page');
